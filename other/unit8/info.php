...
1) З минулого уроку взяти обєднаний масив за допомогою array_merge.
Перевірити чи існує значення ключа з індексом 1, 3,5, 8, 10. Якщо існує вивести його значення.
2) За допомогою array_search знайти ключ з індексом 2, 7. 9 і вивести інформацію чи ключ існує.
